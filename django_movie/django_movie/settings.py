...
SECRET_KEY = 'ybzg&qnate2d0dzehjtot_cdftv^u*^@))%sdp&j)aj__8zp$5'
...
SOCIAL_AUTH_VK_OAUTH2_KEY = ''#id акаунта
SOCIAL_AUTH_VK_OAUTH2_SECRET = ''#секретный кдюч
